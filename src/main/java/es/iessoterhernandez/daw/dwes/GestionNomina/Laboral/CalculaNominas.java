...
public class CalculaNominas {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Empleado empleadoIndividual = new Empleado("Ricardo Gómez", "20062003S", 'M');
            altaEmpleado(empleadoIndividual);

            // Dar de alta empleados a partir de un fichero .txt
            ...
            do {
                ...
                switch (opcion) {
                    case 1:
                        // Mostrar todos los empleados almacenados en la BD
                        mostrarEmpleados();
                        break;
                    case 2:
                        // Mostrar el salario de un empleado específico introduciendo su DNI
                        System.out.print("Introduce el DNI del empleado: ");
                        String dniSalario = scanner.next();
                        mostrarSalarioPorDni(dniSalario);
                        break;
                    case 3:
                        // Modificar los datos de un empleado específico introduciendo su DNI
                        ...
                        break;
                    case 4:
                        // Recalcular y actualizar el sueldo de un empleado introduciendo su DNI
                        System.out.print("Introduce el DNI del empleado: ");
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        // Realizar un backup de la base de datos, guardando los empleados y sus sueldos
    ...
    public static void altaEmpleado(Empleado empleado) {
        // Crear un objeto Nomina y calcular el sueldo del empleado
        ...
        try (Connection conn = DBUtils.getConnection();
            ...
            System.out.println("Empleado " + empleado.getNombre() + " se ha dado de alta o actualizado con éxito.");
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(archivoEntrada))) {
            ...
            while ((linea = reader.readLine()) != null) {
                if (linea.startsWith("nombre:")) {
                    ...
                    // Si el empleado tiene una categoría distinta de 1 y años trabajados distintos
                    // de 0,
                    // se crea un objeto Empleado utilizando el constructor con todos los atributos
                    Empleado empleado;
    ...
    // Muestra los valores de todos los empleados en el menú
    ...
    private static void modificarDatosEmpleado(String dni) {
        ...
        try (Connection conn = DBUtils.getConnection();
                PreparedStatement ps = conn.prepareStatement("SELECT * FROM empleados WHERE dni = ?")) { 
                    // try-with-resources para Scanner
            ps.setString(1, dni);
            try (ResultSet rs = ps.executeQuery()) {
                if (rs.next()) {
                    ...
                    System.out.print("Nuevo sexo (M/F, o pulsa enter para mantener): ");
                    String nuevoSexo = scanner.nextLine();
                    nuevoSexo = nuevoSexo.isEmpty() ? rs.getString("sexo") : nuevoSexo;

                    System.out.print("Nueva categoría (pulsa enter para mantener): ");
                    String nuevaCategoriaStr = scanner.nextLine();
                    int nuevaCategoria = nuevaCategoriaStr.isEmpty() ? rs.getInt("categoria")
                            : Integer.parseInt(nuevaCategoriaStr);

                    System.out.print("Nuevos años (pulsa enter para mantener): ");
    ...
    // Actualiza el salario de un empleado si hay cambios en la categoría o años
    // trabajados
    ...
    // Crea o actualiza un archivo backup.txt en el que figuran todos los empleados
    // y salarios
